...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        red_h_max = rospy.get_param("/marathon_params/line/H_Max")
        red_h_min = rospy.get_param("/marathon_params/line/H_Min")
        red_s_max = rospy.get_param("/marathon_params/line/S_Max")
        red_s_min = rospy.get_param("/marathon_params/line/S_Min")
        red_v_max = rospy.get_param("/marathon_params/line/V_Max")
        red_v_min = rospy.get_param("/marathon_params/line/V_Min")
        blob_size = rospy.get_param("/marathon_params/line/Min_Size")
