...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        ball_h_max = rospy.get_param("/united_soccer_params/vision/H_Max")
        ball_h_min = rospy.get_param("/united_soccer_params/vision/H_Min")
        ball_s_max = rospy.get_param("/united_soccer_params/vision/S_Max")
        ball_s_min = rospy.get_param("/united_soccer_params/vision/S_Min")
        ball_v_max = rospy.get_param("/united_soccer_params/vision/V_Max")
        ball_v_min = rospy.get_param("/united_soccer_params/vision/V_Min")
        ball_erode = rospy.get_param("/united_soccer_params/vision/Erode")
        ball_dilate = rospy.get_param("/united_soccer_params/vision/Dilate")

        field_h_max = rospy.get_param("/united_soccer_params/vision/FH_Max")
        field_h_min = rospy.get_param("/united_soccer_params/vision/FH_Min")
        field_s_max = rospy.get_param("/united_soccer_params/vision/FS_Max")
        field_s_min = rospy.get_param("/united_soccer_params/vision/FS_Min")
        field_v_max = rospy.get_param("/united_soccer_params/vision/FV_Max")
        field_v_min = rospy.get_param("/united_soccer_params/vision/FV_Min")
        field_erode = rospy.get_param("/united_soccer_params/vision/FErode")
        field_dilate = rospy.get_param("/united_soccer_params/vision/FDilate")
        ...
        if ball_found == False:
            if len(ball_contours) > 0:
                ...
                for balls in sorted_ball_contours:
                    ...
                    # debug ball
                    if rospy.get_param("/united_soccer_params/vision/debug_ball"):
                        selected_ball = rospy.get_param("/united_soccer_params/vision/ball_no")
                    ...
                    if not ball_found:
                        ...
                        ball_area_min = rospy.get_param("/united_soccer_params/vision/ball_area_min")
                        ball_area_max = rospy.get_param("/united_soccer_params/vision/ball_area_max")
                        ball_area_ratio_thresh = rospy.get_param("/united_soccer_params/vision/ball_area_ratio")
                        ball_wh_ratio_min = rospy.get_param("/united_soccer_params/vision/ball_wh_ratio_min")                        
                        ball_wh_ratio_max = rospy.get_param("/united_soccer_params/vision/ball_wh_ratio_max")
                        ball_percent_white_thresh = rospy.get_param("/united_soccer_params/vision/ball_percent_white")
